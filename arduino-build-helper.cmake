...
set(ARDUINO_EMPTY_LIBS "" CACHE INTERNAL "Header-only libraries")
set(ARDUINO_ADDED_LIBS "" CACHE INTERNAL "Successfully added arduino libraries")
...
function(probe_arduino_core PROBEPATH)
    if(NOT ARDUINO_CORE_PATH)
        ...
        if(ARDUINO_CORE_SOURCES)
            ...
            set(ARDUINO_ADDED_LIBS ${ARDUINO_ADDED_LIBS} CACHE INTERNAL "Successfully added arduino libraries")
        else()
...
function(add_arduino_library LIBNAME LIBBASEDIR)
    ...
    if(IS_DIRECTORY ${LIBBASEDIR}/${LIBNAME})
        ...
        if(TARGET ${LIBNAME})
            ...
            set(ARDUINO_EMPTY_LIBS ${ARDUINO_EMPTY_LIBS} CACHE INTERNAL "Header-only libraries")
        endif()
        if(LIBADDED)
